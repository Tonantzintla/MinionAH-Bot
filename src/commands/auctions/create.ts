...
export default new SlashCommandSubcommandBuilder()
  ...
  .addStringOption((option) => option.setName("minion_type").setDescription("The type of the minion to create an auction for").setRequired(true).setAutocomplete(true))
  .addIntegerOption((option) => option.setName("minions_amount").setDescription("The amount of minions to auction (max 512)").setRequired(true))
