...
const invalidAuctionCreateDisplayContainer = new ContainerBuilder()
  .addTextDisplayComponents((t) => t.setContent("### Invalid Auction Creation"))
  .addTextDisplayComponents((t) =>
    t.setContent(
      "The auction creation options provided are invalid. Please check your inputs and try again."
    )
  )
...
const confirmedAuctionCreationDisplayContainer = new ContainerBuilder()
  ...
  .addTextDisplayComponents((t) =>
    t.setContent(
      "Your auction has been successfully created and is now live on MinionAH!"
    )
  )
  .addSeparatorComponents((s) => s.setSpacing(SeparatorSpacingSize.Large))
  .addTextDisplayComponents((t) =>
...
const cancelledAuctionCreationDisplayContainer = new ContainerBuilder()
  .addTextDisplayComponents((t) =>
    t.setContent("### ❌ Auction Creation Cancelled")
  )
  .addTextDisplayComponents((t) =>
    t.setContent(
      "Your auction creation has been cancelled. You can start over anytime!"
    )
  )
  .addSeparatorComponents((s) => s.setSpacing(SeparatorSpacingSize.Large))
  .addTextDisplayComponents((t) =>
